...
source ~/openfoam/openfoam2012/etc/bashrc
source ~/openfoam/openfoam2012/applications/utilities/ITHACA-FV/etc/bashrc
...
alias bolo='cd ~/openfoam/openfoam2012/run/bologna_case'
